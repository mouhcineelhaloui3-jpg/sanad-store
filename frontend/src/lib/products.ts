...
export const products: Product[] = [
  {
    ...
    reviews: [
      { name: "سناء", city: "الدار البيضاء", rating: 5, text: "كنخدم 8 ساعات قدام اللابتوب. منين بديت نستعمل سَنَد ألاين حسيت بالكتاف كيتسندو شوية بلا ما يكون قاسح. الطلب كان بسيط والتأكيد بالهاتف عطاني ثقة." },
      { name: "أحمد", city: "الرباط", rating: 4, text: "ما بغيتش وعد طبي، بغيت غير تذكير بالوضعية. كيخدم معايا فالخدمة، خاصة ملي كتطول الجلوس. الشد قابل للتعديل وهادشي اللي عجبني." },
      { name: "ليلى", city: "مراكش", rating: 5, text: "الدفع عند الاستلام هو اللي خلاني نجرّب. وصلني الطلب فوقت معقول وتواصلو معايا قبل ما يرسلوه. المنتج خفيف وماشي محرج فاللبس." },
      { name: "ياسين", city: "طنجة", rating: 5, text: "كنقرا بزاف والكتاف كيطياحو. هاد الدعم كيعطيني وعي بالوضعية فالنهار. ما كنديروش ساعات طويلة فالأول حتى نتعود." },
      { name: "منال", city: "أكادير", rating: 4, text: "سولت على واتساب قبل ما نطلب وجاوبوني بصراحة وقالولي واش يناسبني. هاد النوع ديال الخدمة ماشي عند كل المتاجر." }
    ],
    faqs: [
  ...
  },
  {
    ...
    reviews: [
      { name: "يوسف", city: "مراكش", rating: 5, text: "من بعد السياقة الطويلة كتكون رقبتي مشدودة. كنحط سَنَد هيت فالدار 15 دقيقة والحرارة لطيفة بزاف. ماشي علاج ولكن كيعطيني راحة حقيقية." },
      { name: "نادية", city: "طنجة", rating: 4, text: "كنستعملو ملي كتسالي الخدمة قدام الكمبيوتر. الاهتزاز خفيف ومريح، والاستعمال ساهل بلا تعقيد." },
      { name: "عمر", city: "أكادير", rating: 5, text: "سولت على واتساب قبل الطلب وشرحولي الفرق بين المنتجات بلا ما يضغطوني. هادشي اللي خلاني نثق ونطلب." },
      { name: "هاجر", city: "الرباط", rating: 5, text: "هدية لأمي اللي كتعاني من شد فالرقبة. عجباتها الحرارة والاهتزاز، وقالت ليا ساهل فالاستعمال فالدار." },
      { name: "رضوان", city: "الدار البيضاء", rating: 4, text: "الدفع عند الاستلام ريحني. جربت المنتج من بعد نهار طويل فالخدمة وكنحس براحة أكثر فالرقبة والكتاف." }
    ],
    faqs: [
  ...
  },
  {
    ...
    reviews: [
      { name: "فاطمة", city: "فاس", rating: 5, text: "كنوقف بزاف فالخدمة كبائعة وأسفل ظهري كيتقل. سَنَد لومبو ساهل فاللبس وكتتحكم فالضغط حسب راحتك. كيتلبس ويتخلع بسرعة." },
      { name: "كريم", city: "الدار البيضاء", rating: 4, text: "مناسب للسياقة الطويلة بين المدن. ما كنعدوش بنتائج طبية ولكن كتحس بثبات أكثر فالظهر ملي كتسوق." },
      { name: "حسن", city: "وجدة", rating: 5, text: "الطلب بسيط: غير الاسم والهاتف. الدفع عند الاستلام والتأكيد بالهاتف عطاني ثقة بلا ما نخلص قبل ما نشوف السلعة." },
      { name: "زينب", city: "مكناس", rating: 5, text: "كنخدم فالبيت وكنتحمل بزاف. الحزام كيعطيني دعم ملي كنقف أو نطيح. ما كيبانش بزاف تحت الملابس الواسعة." },
      { name: "عادل", city: "طنجة", rating: 4, text: "كنستعملو فالسياقة والخدمة. الإحساس بالدعم واضح من أول استعمال. كننصح بيه لي كيقف بزاف." }
    ],
    faqs: [
